...
export const generateAndRunPythonCodeDescription = {
	...
	function: {
		...
		description:
			"Generate and run some python code that can solve the problem at hand. End the program with a print() with the result",
		parameters: {
			type: "object",
			properties: {
				code: {
					type: "string",
					description:
						"This is the code that will be run. it should end with a print() with the result.",
				},
			},
		},
	},
