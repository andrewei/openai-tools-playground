...
export const getCarInfoDescription = {
	...
	function: {
		name: "get_car_info",
		description:
			"Get information about a Tesla car. If the user talks about a Tesla or a car, it is this one. It returns information like Battery charge, Car name, etc. A JSON format with information will be the result of the function.",
	},
};
